...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Kiem tra ket noi internet");
        ...
        System.out.println("Cai dat ddos 170000 & 4000");

        System.out.print(" Du lieu truyen ve  : ");
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Nhan tan cong thanh cong ! : " + responseCode + " Du lieu truyen ve  : " + this.seq);
    }
